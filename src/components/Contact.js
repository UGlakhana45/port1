  ...
  return (
    ...
    >
      <div className="container px-2 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="md:w-1/2 lg:w-2/3  bg-white  rounded-lg overflow-hidden sm:mr-10 p-10 flex   relative">
          <div className=" relative flex flex-wrap py-10 rounded shadow-md mb-8">
            <motion.img
              src={Hero}
              alt="placeholder"
